package com.eduinapps.recipesapi.util;
...
public abstract class NetworkBoundResource<CacheObject, RequestObject> {
    ...
    private com.eduinapps.recipesapi.AppExecutors appExecutors;

    public NetworkBoundResource(com.eduinapps.recipesapi.AppExecutors appExecutors) {
